...
* In the link:network-quickstart{outfilesuffix}[IC deployment] scenario, you create the sample dapp locally but _connect to the {IC} blockchain_ running node machines in independent data centers and deploy the dapp there.
