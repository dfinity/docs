...
--
+
For more information about using a query call, see link:../concepts/canisters-code{outfilesuffix}#query-calls[query calls] in link:../concepts/canisters-code{outfilesuffix}#canister-state[Canisters include both program and state].
...
"actor_hello" canister created with canister id: "rwlgt-iiaaa-aaaaa-aaaaa-cai"
....
+
...
+
....
Installing code for canister actor_hello, with canister_id rwlgt-iiaaa-aaaaa-aaaaa-cai
....
...
+
....
[Canister rwlgt-iiaaa-aaaaa-aaaaa-cai] Hello, World from DFINITY
....
+
