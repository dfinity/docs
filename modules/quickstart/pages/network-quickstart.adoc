...
CAUTION: Because application subnets are not yet widely available to the general public, canister deployment on the mainnet is currently disabled. Trying to do it will fail and cost you some ICP tokens.
