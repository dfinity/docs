...
[[example-code-intro]]
To show the possibilites of building on the IC it's worth taking a look at some sample dapps. You can also check out our https://github.com/dfinity/examples[Examples Repo], https://github.com/dfinity/awesome-dfinity[Awesome Dfinity], a curated set of open-source projects and examples from our community, or link:./hackathon-projects.html[Hackathon Projects]!
