...
There are more detailed examples and tutorials for you to explore in the link:../developers-guide/introduction-key-concepts{outfilesuffix}[_SDK Developer Tools_] and in the link:../language-guide/motoko{outfilesuffix}[_{proglang} Programming Language Guide_].
