...
|`+--network <network>+` |Specifies the {platform} you want to connect to. You can use this option to override the network specified in the `+dfx.json+` configuration file.
