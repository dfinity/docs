...
Before you can install the `+multiple_actors+` project locally, you need to start your local canister execution environment. If you intend to deploy it to the {IC} blockchain mainnet, then you can skip this section.
