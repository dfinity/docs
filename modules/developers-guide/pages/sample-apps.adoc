...
Because updates to the website and link:https://github.com/dfinity/examples[public repository] are still forthcoming, no sample projects are currently available for direct download access yet. 
