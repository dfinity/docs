...
<div class="home-pitches-grid">
    ...
    <div class="landing-pitch">
        <a href="developers-guide/webpack-config.html"><img src="_images/CorporateCloud.png" height="320" width="320" /></a>
        ...
        <p class="link"><a href="developers-guide/webpack-config.html">Read more about front-end development</a></p>
    </div>

    <div class="landing-pitch">
        <a href="language-guide/motoko.html"><img src="_images/MotokoLogo.png" height="320" width="320" /></a>
        ...
        <p class="link"><a href="language-guide/motoko.html">Read more about Motoko</a></p>
    </div>

    <div class="landing-pitch">
        <a href="candid-guide/candid-intro.html"><img src="_images/RustLogo.png" height="320" width="320" /></a>
        ...
        <p class="link"><a href="candid-guide/candid-intro.html">Read more about Candid</a></p>
    </div>
