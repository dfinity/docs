...
=== Connect to an execution environment and deploy

Before you can deploy and test your dapp, you need to do the following:

* Connect to either the local canister execution environment, or to the {IC} blockchain mainnet, to a subnet that you can access.
