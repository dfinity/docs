...
Note: A fresh install of node.js can take anywhere from 2-15 minutes depending on your internet connection.
...
=== 4.1 Acquiring cycles (Terminal B)
...
=== 4.2 Loading the canister with cycles (Terminal B)
