...
. Specify the canister identifier in the *Provide a canister ID* field and, if you have one, upload the (`+.did+`) file to the *Choose a did file* field, then click *Go* to display the system description.
