...
* The program uses the `+public query func+` to define a query method because, in this case, the `+actor_hello+` program doesn't make any changes to the state of the canister smart contract or perform any operations that would update the data you are accessing.
--
+
