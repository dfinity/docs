...
+
For example, click *Shell*, select *New Window*, then run the following command in the new terminal if your `+hello+` project is in the `+ic-projects+` working folder:
+
[source,bash]
----
