...
<script>
    ...
    */
    ...
    function showTutorial(tutorial) {
        ...
        htmlNode = document.createElement('span');
        htmlNode.innerHTML = "<div class=\"info-duration\">25 minutes</div><div class=\"info-updated\">November 20, 2021</div>";
        node.appendChild(htmlNode);
    ...
    var tutorials = [
        {
          ...
          "url": "https://smartcontracts.org/docs/examples/codelabs/data-persistence.html"
        },
        {
          "id": "",
          ...
          "url": "https://smartcontracts.org/docs/examples/codelabs/minimal-motoko-dapp.html"
        },
        {
          "id": "",
        ...
        },
        {
          ...
          "url": "https://smartcontracts.org/docs/examples/codelabs/simple-nft.html"
        },
        {
          "id": "",
          ...
          "url": "https://smartcontracts.org/docs/examples/codelabs/static-website.html"
        }
    ];
