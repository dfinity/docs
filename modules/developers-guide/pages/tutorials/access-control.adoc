...
NOTE: You can register, build, and deploy your application in a single step by running the link:../cli-reference/dfx-deploy{outfilesuffix}[`dfx deploy`] command. This tutorial demonstrates performing each of these steps independently to illustrate creating a default identity, registering identifiers for local and network deployment, and deploying specific canisters instead of all canisters in a project.
...
Creating the "default" identity.
  - migrating key from /Users/pubs/.dfinity/identity/creds.pem to /Users/pubs/.config/dfx/identity/default/identity.pem
