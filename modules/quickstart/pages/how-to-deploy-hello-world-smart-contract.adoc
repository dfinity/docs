How to deploy a "hello world" smart contract/dapp in 10 minutes
===============================================================
...
If you wish to start from scratch, you can delete SDK and associated profiles and re-install it.
