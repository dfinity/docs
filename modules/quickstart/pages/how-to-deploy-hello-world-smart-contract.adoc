...
1. Use the Terminal window/tab A on your local computer.
...
3. Start the local canister execution environment on your computer in your Terminal A by running the following command:
...
Verify the current status of the Internet Computer blockchain and your ability to connect to it by running the following command for the network alias `ic`:
