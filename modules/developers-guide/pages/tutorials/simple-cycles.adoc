...
Before you can build the `+access_hello+` project, you need to connect to the local canister execution environment running locally in your development environment or you need to connect toa subnet that you can access.
