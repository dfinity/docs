...
[[example-code-intro]]
Take a look at some sample dapps below and see the possibilities of building on the IC. All samples and further projects can be found in the https://github.com/dfinity/examples[Samples Repo]. Additional resources can be found in the https://github.com/dfinity/awesome-dfinity[Awesome Dfinity] repos (a curated set of open-source projects and examples from our community) or link:./hackathon-projects.html[Hackathon Projects]!
