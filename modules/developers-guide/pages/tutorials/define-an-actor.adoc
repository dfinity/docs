...
....
+
If the program compiles successfully, you can inspect the output in the default `+canisters+` directory.
...
+
....
"actor_hello" canister created with canister id: "ic:0100000000000000000000000000000000012D"
....
+
The `+dfx canister create+` command also stores the network-specific canister identifier in a file in the `+canisters+` directory.
+
For example:
+
....
insert canister id file content
....
...
+
....
Installing code for canister actor_hello, with canister_id ic:0100000000000000000000000000000000012D
....
