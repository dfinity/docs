...
|<<dfx canister send,`+send+`>> |Send a signed `message.js` to create neurons.

|<<dfx canister send,`+sign+`>> |Create a signed `message.js` file to customize the process of creating neurons.
