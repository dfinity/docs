...
You can use this local identifier while you are testing your canister or any time you want to compile your canister without starting the local canister execution environment process locally.
