...
. Specify the canister identifier or description file for your dapp into the *Provide a canister ID* field, then click *Go* to display the service description.
