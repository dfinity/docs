...
* link:explore-templates{outfilesuffix}[Exploring the default project] illustrates the basic work flow for creating projects and deploying sample code to run on an {IC} node using the default sample project.
