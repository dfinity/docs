...
- The `+dfx build+` command now supports building all or specific canister.
+
...
+
Because of this change to the `+dfx build+` command, the `+--skip-frontend+` option is no longer needed and has been deprecated.
