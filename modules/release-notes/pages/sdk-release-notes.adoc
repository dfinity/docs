...
* Key updates for {proglang} include backend support for the following features:
...
* to move the declarations that preceded the main actor into the actor's body; or
* to move the declarations into a new, imported module, referenced from the main actor; or
