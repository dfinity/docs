...
Before you can build your project, you need to connect to a local canister execution environment or to a real subnet on the Internet Computer that you can access.
