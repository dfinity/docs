...
+
....
include::example$sample-0.6.2-dfx.json[]
....
+
...
+
If you have access to other {IC} network providers, the `+networks+` can include network aliases and URLs for connecting to those providers.
--
+
