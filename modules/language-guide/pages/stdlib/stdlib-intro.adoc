...
This example illustrates how to import {proglang} code—indicated by using the `mo:` prefix—using the `base/` standard library path and the module name `prelude`.
