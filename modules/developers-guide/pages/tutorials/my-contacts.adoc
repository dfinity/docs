...
For example, if you are connecting to the URL specified by the network alias `+tungsten+` in the project `+dfx.json+` file, you would run a command similar the following:
+
[source,bash]
----
