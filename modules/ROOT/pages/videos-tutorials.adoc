...
If you want to learn more after watching the video, check out link:developers-guide/concepts-intro{outfilesuffix}[Concepts].
...
If you want to learn more after watching the video, check out link:developers-guide/what-is-IC{outfilesuffix}#next-gen[Building the next generation of software and services].
