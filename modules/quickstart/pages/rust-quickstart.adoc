...
+
....
"rust_hello" canister created with canister id: "ic:0100000000000000000000000000000000012D"
....
...
+
You should see output similar indicating the packages compiled.
...
+
....
Installing code for canister rust_hello, with canister_id ic:0100000000000000000000000000000000012D
....
...
....
+
Note that because you are running the Internet Computer network in a separate terminal instead of in the background, the "Hello, World from DFINITY" message is displayed in the terminal that displays network activity.
