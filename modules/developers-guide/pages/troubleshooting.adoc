...
----
+
The `+--clean+` option removes checkpoints and stale state information from your project's cache so that you can starts the {IC} replica and web server processes in a clean state.
