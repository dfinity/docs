...
For example, if you list the contents of the `~/.cache/dfinity/versions/0.6.0` directory you would see the following core components:
...
The `+bootstrap+` directory in the versioned subdirectory of the {sdk-short-name} provides files to support local front-end development and the local web server.
