...
You cab find more detailed examples and tutorials to help you learn about how to use {proglang} and how to develop applications to run on the {IC} throughout the documentation.
...
* link:../language-guide/language-manual{outfilesuffix}[{proglang} at-a-glance] to learn about the features and syntax for using {proglang}.
