...
Next, we’ll explore writing a few simple programs using the {proglang} programming language to give you hands-on experience working with programs that run on the {IC}. 
