...
* You have installed the Visual Studio Code plugin for {proglang} as described in link:../../quickstart/quickstart-intro{outfilesuffix}#install-vscode[Install the language editor plug-in] if you are using Visual Studio Code as your IDE.
...
* Click *Shell* and select *New Window*, then run `+cd ~/ic-projects/custom_greeting+` in the new terminal if your `+custom_greeting+` project is in the `+ic-projects+` working folder.
--
+
...
+
....
"custom_greeting" canister created with canister id: "75hes-oqbaa-aaaaa-aaaaa-aaaaa-aaaaa-aaaaa-q"
"custom_greeting_assets" canister created with canister id: "cxeji-wacaa-aaaaa-aaaaa-aaaaa-aaaaa-aaaaa-q"
....
...
+
....
Installing code for canister custom_greeting, with canister_id 75hes-oqbaa-aaaaa-aaaaa-aaaaa-aaaaa-aaaaa-q
Installing code for canister custom_greeting_assets, with canister_id cxeji-wacaa-aaaaa-aaaaa-aaaaa-aaaaa-aaaaa-q
....
