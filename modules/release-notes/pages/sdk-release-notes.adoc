...
+
For example, you might use the following command to add the xx argument when deploying the canister named profile_map locally.
+
....
dfx canister install profile_map xx
....
