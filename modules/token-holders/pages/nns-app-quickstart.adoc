...
. Click **Proceed** to access to the Network Nervous System (NNS) application. 
. Click **Voting**.
. Click any of the proposals listed to view information about the proposal, voting results, and the number of votes that were cast to adopt or reject the proposal.
