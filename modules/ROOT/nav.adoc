...
** Dfinity Examples
*** link:https://github.com/dfinity/examples[Dfinity Examples Repo]
*** xref:examples:defi.adoc[DEFI Example]
...
// **** xref:developers-guide:default-wallet.adoc[Use the default cycles wallet]  commented out because it had error in netlify logs
...
// ****** xref:language-guide:errors.adoc[Error handling] commented out because it had error in netlify logs
