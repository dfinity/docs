...
If you want to register unique canister identifiers for the same project when the {IC} runs on the network that uses the tungsten alias in the `+dfx.json+` file, you can run the following command:
