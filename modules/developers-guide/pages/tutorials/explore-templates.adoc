...
* The `+canisters+` section specifies that the main program to be complied is located in the path specified by the `+main+` setting, in this case, `+src/explore_hello/main.mo+`.
...
....
{
  "canisters": {
    "explore_hello": {
      "candid_path": "/Users/pubs/ic-projects/explore_hello/canisters/explore_hello/explore_hello.did",
      "canister_id": "ic:05000000000000000000000000000000000185",
      "timestamp": "Sat, 13 Jun 2020 00:04:13 +0000",
      "wasm_path": "/Users/pubs/ic-projects/explore_hello/canisters/explore_hello/explore_hello.wasm"
    },
    "hello_world_assets": {
      "candid_path": "/Users/pubs/ic-projects/explore_hello/canisters/hello_world_assets/hello_world_assets.did",
      "canister_id": "ic:060000000000000000000000000000000001FB",
      "timestamp": "Sat, 13 Jun 2020 00:04:14 +0000",
      "wasm_path": "/Users/pubs/ic-projects/explore_hello/canisters/hello_world_assets/hello_world_assets.wasm"
    }
  }
}
....
...
[source,bash]
----
dfx canister install explore_hello
----
+
The command displays output similar to the following:
+
....
Installing code for canister explore_hello, with canister_id ic:05000000000000000000000000000000000185
....
. Call the predefined `+greet+` function in the program by running the following command:
+
[source,bash]
----
dfx canister call explore_hello greet "everyone" --type string
----
+
