...
. Enter your project canister identifier for your application into the **Provide a canister ID** field, then click **Go**.
+
...
. Click **RANDOM** to generate a value, then click **QUERY** to see the result.
+
For example, in the METHODS section of the webpage, the program displays `+hello+`, while in the terminal, the display might read, `+"Hello, World from DFINITY"+` in output similar to the following:
+
....
