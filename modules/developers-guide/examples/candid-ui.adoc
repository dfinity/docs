...
+
. Specify the canister identifier in the *Provide a canister ID* field or upload the (`+.did+`) file to the *Choose a did file* field, then click *Go* to display the service description.
