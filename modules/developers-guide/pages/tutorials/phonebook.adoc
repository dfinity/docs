...
For this tutorial, however, you can deploy just the phonebook back-end canister using the `+dfx deploy phonebook+` command because the project is a terminal-based application that doesn't include any front-end assets.
+
