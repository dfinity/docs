...
Before you can deploy this project, you must connect to the {IC} network either running *locally* in your development environment or running on a subnetwork *remotely*.
