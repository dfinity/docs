...
For this release, the following limitations apply for IDL arguments:

* No support for type annotations.
* No support for Bignum.

==== Limitations for return values

For this release, the following limitations apply for displaying method return values:
