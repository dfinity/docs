...
<div class="home-pitches-grid">
    ...
    <div class="landing-pitch">
        ...
        <p>It is so packed with familiar features — like async/await, randomness, time and date, and even floating point numbers — that you might just forget you're building directly on a new kind of blockchain computer.</p>
